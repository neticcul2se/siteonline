...
<h3 class="text-center pt-2 pb-2 bg-light  col-sm-12 Chiller">AHU 1-9 </h3>
<hr>
<br>
...
<div class="tableresponsive">
  <table class="tabledata">
         ...
         <tbody>
<form class="form" id="myform1 " name="form1" method="post" action="insertAHU1_9.php" >
  <div class="form-group row ">
     <label for="select_Machine" class="col-sm-6 col-form-label inmachine" ><b>Select AHU * </b></label>
...
$sql = "SELECT * FROM Question where groupq='AHU1_9'";
