...
<div class="subpage">
  <h4 class="text-center col-sm-12 headmt">VISY CHILLER 6-7 </h4>
  ...
  $sql = "SELECT * FROM visy6_7 where id='$idv'";
...
?>
<form class="form" id="myform1 " name="form1" method="post" action="edit6_7.php" >
