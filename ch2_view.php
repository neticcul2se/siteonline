...
<div class="col-sm-9">
 ...
 <form class="no-print form" id="myform2  " name="form2" method="get" action="ch2_view.php" >
...
<div class="col-sm-3">
  <form class="no-print form" id="myform3  " name="form2" method="get" action="form_edit_ch2.php">
