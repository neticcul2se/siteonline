...
<h3 class="text-center pt-2 pb-2 bg-light  col-sm-12 Chiller">Export Data Visy 1-3  </h3>
    ...
    <form class="form" id="myform1 " name="form1" method="post" action="excel2.php" >
...
<p><b>Please select Date or Month </b></p>
<input  type="radio" name="md" value="date" checked> Date<br>
<input type="radio" name="md" value="month"> Month<br>
