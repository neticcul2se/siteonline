...
$sql = "INSERT INTO AHU1_9 ( as1, as2, as3, as4, as5, as6, as7, as8, as9 , as10
, as11, as12, as13, as14, as15, as16, as17, as18, as19 , as20
, as21, as22, as23, as24, as25, as26, as27,Inspector,type,addtime)
VALUES ('$as1', '$as2', '$as3', '$as4', '$as5', '$as6', '$as7', '$as8', '$as9' , '$as10'
, '$as11','$as12', '$as13', '$as14', '$as15', '$as16', '$as17', '$as18', '$as19' , '$as20'
, '$as21', '$as22', '$as23', '$as24', '$as25', '$as26', '$as27','$inspector','$visy','$n_date')";

echo $sql;
if ($conn->query($sql) === TRUE) {

  $sqls = "SELECT max(id) as id FROM AHU1_9";
  ...
  header( "location: formviewAHU1_9.php" );
      exit(0);
} else {
