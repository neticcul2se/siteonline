...
<hr class="showhead"/>
 ...
 <form class="no-print form" id="myform2  " name="form2" method="get" action="viewmachine.php" >
   <div class="form-group row ">
  <div class="col-sm-4 "> <label for="dateselect" class="col-sm-4 col-form-label" >select date </label> </div>
  <div class="col-sm-4 "> <input data-date-format="dd/mm/yyyy" id="datepicker" name="datepicker1"> </div>
  <button type="submit" name="btn_submit" id="btn_submit" value="1" class="btn btn-primary col-sm-4 ">get data</button>
...
<h4 class="no-print bg-light text-dark p-2" style="text-align:center">Results Machine <?= $num; ?> </h4>
