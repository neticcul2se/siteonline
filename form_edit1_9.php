...
<div class="subpage">
  <h4 class="text-center col-sm-12 headmt">AHU 1-9  </h4>
  ...
  $sql = "SELECT * FROM AHU1_9 where id='$idv'";
  $result = $conn->query($sql);

  $sql2 = "SELECT * FROM Question where groupq='AHU1_9'";
...
?>
<form class="form" id="myform1 " name="form1" method="post" action="edit1_9.php" >
...
<div class="text-center">
  <H4>Visy:  <select class="custom-Machine required" name="select_visy" id="select_visy" required>
         ...
         <option value="2"<?php if($row["type"]=="2"){ echo "selected='selected'";} ?> >2</option>
         
         <option value="3"<?php if($row["type"]=="3"){ echo "selected='selected'";} ?> >3</option>
          <option value="4"<?php if($row["type"]=="4"){ echo "selected='selected'";} ?> >4</option>
           <option value="5"<?php if($row["type"]=="5"){ echo "selected='selected'";} ?> >5</option>
            <option value="6"<?php if($row["type"]=="6"){ echo "selected='selected'";} ?> >6</option>
             <option value="7"<?php if($row["type"]=="7"){ echo "selected='selected'";} ?> >7</option>
              <option value="8"<?php if($row["type"]=="8"){ echo "selected='selected'";} ?> >8</option>
               <option value="9"<?php if($row["type"]=="9"){ echo "selected='selected'";} ?> >9</option>
       </select> </H4>
</div>
