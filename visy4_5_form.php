...
<h3 class="text-center pt-2 pb-2 bg-light  col-sm-12 Chiller">VISY CHILLER 4-5 </h3>
<hr>
<br>
...
<div class="tableresponsive">
  <table class="tabledata">
         ...
         <tbody>
<form class="form" id="myform1 " name="form1" method="post" action="insertvisy4_5.php" >
...
$sql = "SELECT * FROM Question where groupq='visy4_5'";
...
if ($result->num_rows > 0) {
 ...
 ?>
             ...
             <td data-title="B">  <input type="text" class="form-control" name="input2_as<?=$num;?>" id="input2_as<?=$num;?>"
