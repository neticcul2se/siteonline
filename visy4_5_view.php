...
<h4 class="text-center col-sm-12 showhead">VISY CHILLER 4-5 </h4>
<hr class="showhead"/>
<div class="row">
<div class="col-sm-9">
...
<div class="col-sm-3">
<form class="no-print form" id="myform3  " name="form2" method="get" action="form_edit4_5.php">
...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/js/bootstrap.min.js" integrity="sha384-JZR6Spejh4U02d8jOt6vLEHfe/JQGiRRSQQxSfFWpi1MquVdAyjUar5+76PVCmYl" crossorigin="anonymous"></script><script type="text/javascript">
    ...
    <h4 class="text-center col-sm-12 myhead">VISY CHILLER 4-5 </h4>
    <hr class="hrshow">
