...
<h1 class="text-center pt-5 col-sm-12 Chiller">Chiller daily inspection </h1>
<hr>
<br>
...
<form class="form" id="myform1 " name="form1" method="post" action="insert1.php" >
  <div class="form-group row ">
     ...
     <div class="col-sm-4 inmachine ">
        <select class="custom-Machine required" name="select_Machine" id="select_Machine" >
...
<div class="form-group row  ">
    <div class="col-sm-12  text-center ">
         <button type="submit" name="btn_submit" id="btn_submit" value="1" class="btn btn-primary ">SEND DATA</button>
    </div>
