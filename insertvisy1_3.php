...
$sql = "INSERT INTO visy1_3 ( as1, as2, as3, as4, as5, as6, as7, as8, as9 , as10
...
if ($conn->query($sql) === TRUE) {
  ...
  $sqls = "SELECT max(id) as id FROM visy1_3";
  ...
  header( "location: formviewvisy1_3.php" );
      exit(0);
} else {
