...
$sql = "INSERT INTO mt_ch2 ( as1, as2, as3, as4, as5, as6, as7, as8, as9 , as10
...
if ($conn->query($sql) === TRUE) {
  ...
  $sqls = "SELECT max(id) as id FROM mt_ch2";
  ...
  header( "location: formviewch2.php" );
      exit(0);
} else {
